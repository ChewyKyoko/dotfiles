...
QtObject {
    ...
    readonly property string scriptDir: {
        let url = Qt.resolvedUrl("../../scripts/");
        return url.toString().replace(/^file:\/\//, "");
    }
    readonly property string setThemeScript: scriptDir + "/set-theme"
    readonly property string thumbScript: scriptDir + "/generate-thumbs.sh"
