    ...
    LazyLoader {
        ...
        component: Component {
            Item {
                ...
                // Click on transparent background closes emoji picker
                MouseArea {
                    anchors.fill: parent
                    onClicked: emojiWindow.closeMenu()
                }
                ...
                Rectangle {
                    ...
                    TextField {
                        ...
                        Timer {
                            ...
                            interval: 120
                            repeat: false
                            onTriggered: ctrl.searchText = debouncedText
                        }
                        ...
                        // Pipe visual typing up into controller layer with debounce
                        onTextChanged: {
                            debouncedText = text;
